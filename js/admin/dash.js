...
import { esc, dt, pts, ago } from '../core/format.js?v=10';
import { colonyById, NOTICE_TYPES } from '../data/labels.js?v=10';
import { kogane, sprite } from '../core/sprites.js?v=10';
import { type } from '../core/typewriter.js?v=10';
